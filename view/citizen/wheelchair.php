    ...
    <main class="cntrs">
        ...
        <form method="post">
            ...
            <div class="wheelchair-count-box">
                ...
                <input type="number" id="wheelchairNumber" name="wheelchairNumber" min="1" placeholder="Enter quantity" value="<?= htmlspecialchars($wheelchairNumber); ?>">
            </div>
            <div class="btnss">
                <button type="submit" class="primary-btn">Continue</button>
                <a href="../../controller/citizen/dashboard.php">
                    <button type="button" class="secondary-btn">Dashboard</button>
                </a>
            </div>
        </form>
    </main>
