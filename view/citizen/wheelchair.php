...
<p>
Does the patient need a wheelchair?
</p>
...
value="No"
class="toggle-no"
<?= (isset($wheelchair) && $wheelchair == "No") ? "checked" : ""; ?>
>

<label for="wheelchairNo" class="radio-label">
No
</label>
...
value="Yes"
class="toggle-yes"
<?= (isset($wheelchair) && $wheelchair == "Yes") ? "checked" : ""; ?>
>

<label for="wheelchairYes" class="radio-label">
Yes
</label>
...
value="<?= isset($wheelchairNumber) ? htmlspecialchars($wheelchairNumber) : ''; ?>"
>
